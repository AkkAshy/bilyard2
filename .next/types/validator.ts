...
// Validate ../../src/app/api/esp/status/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/esp/status">> = Specific
  const handler = {} as typeof import("../../src/app/api/esp/status/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
