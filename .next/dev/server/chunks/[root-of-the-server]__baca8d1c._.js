...
"[project]/src/lib/esp.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// Функции для управления ESP-12F
const ESP_TIMEOUT = 5000; // 5 секунд таймаут
async function sendESPCommand(espIpAddress, gpioPin, turnOn) {
    try {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$esp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/esp.ts [app-route] (ecmascript)");
;
;
;
;
// Функция расчёта стоимости
function calculateCost(durationMinutes, hourlyRate) {
...
async function PUT(request, { params }) {
    try {
        const authSession = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"])();
        if (!authSession) {
        ...
        const actualDuration = Math.round((endedAt.getTime() - existingSession.startedAt.getTime()) / 60000);
        ...
        const espResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$esp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["turnOffLight"])(existingSession.table.espIpAddress, existingSession.table.gpioPin);
        if (!espResult.success) {
            console.error(`Failed to turn off light for table ${existingSession.tableId}:`, espResult.error);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__baca8d1c._.js.map