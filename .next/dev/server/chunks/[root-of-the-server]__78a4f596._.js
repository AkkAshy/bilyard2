...
async function POST(request) {
    try {
        ...
        const table = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].billiardTable.findUnique({
            where: {
                id: tableId
            }
        });
        ...
        const activeSession = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findFirst({
            where: {
                tableId,
                status: "ACTIVE"
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__78a4f596._.js.map